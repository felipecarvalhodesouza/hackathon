...
public class ConsultaController {
    ...
    @Autowired
    public ConsultaController(BuscarHorariosDisponiveisUseCase buscarHorariosDisponiveisUseCase, BuscarMedicosDisponiveisUseCase buscarMedicosDisponiveisUseCase) {
